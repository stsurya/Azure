...
Total Retention = Interactive Retention + Archive Retention

- There are two types of plans which are associated which is Analytics or Basic.
    - In Basic plan, the interactive retention is by default 8days and you can't change it, whereas archive retention is 7years.
